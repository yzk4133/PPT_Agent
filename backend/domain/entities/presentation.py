...
if TYPE_CHECKING:
    from domain.models.slide import Slide, SlideList
    from domain.models.topic import TopicList
    from domain.models.research import ResearchResults

# For runtime, use forward references
Slide = None  # type: ignore
SlideList = None  # type: ignore
