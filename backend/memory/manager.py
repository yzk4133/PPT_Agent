...
from .layers.l1_transient import L1TransientLayer
from .layers.l2_short_term import L2ShortTermLayer
from .layers.l3_longterm import L3LongtermLayer
...
class HierarchicalMemoryManager:
    ...
    def __init__(
        ...
        self.promotion_engine = (
            PromotionEngine(config=promotion_config) if enable_auto_promotion else None
        )
