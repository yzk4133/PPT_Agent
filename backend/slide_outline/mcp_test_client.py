...
async def call_tool(name: str, tool_args: dict):
    async with client:
...
async def main():
    # Step1: list tools
    await list_tools()
    # Step2: test tools, e.g., "DocumentSearch" if available
    await call_tool("DocumentSearch", tool_args={"keyword": "ChatGPT"})
