...
class AppConfig(BaseSettings):
    ...
    class Config:
        ...
        case_sensitive = False
        # 支持嵌套配置的环境变量，如 DB_POSTGRES_HOST
        fields = {
            "split_topic_agent": {"env_prefix": "AGENT_SPLIT_TOPIC_"},
            "research_agent": {"env_prefix": "AGENT_RESEARCH_"},
            "ppt_writer_agent": {"env_prefix": "AGENT_PPT_WRITER_"},
            "ppt_checker_agent": {"env_prefix": "AGENT_PPT_CHECKER_"},
            "outline_agent": {"env_prefix": "AGENT_OUTLINE_"},
        }
