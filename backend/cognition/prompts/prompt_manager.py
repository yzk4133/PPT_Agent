...
class PromptManager:
    ...
    def _load_prompts(cls) -> None:
        ...
        try:
            ...
            cls._template_mappings.update(PLANNING_VERSIONS)
        except ImportError:
            pass

        try:
            from .templates.research_prompts import (
                RESEARCH_TOPIC_AGENT_PROMPT,
                DOCUMENT_ANALYSIS_PROMPT,
                PROMPT_VERSIONS as RESEARCH_VERSIONS,
            )

            cls._prompts["research"]["v1"] = RESEARCH_TOPIC_AGENT_PROMPT
            cls._prompts["research"]["document_analysis_v1"] = DOCUMENT_ANALYSIS_PROMPT
            cls._template_mappings.update(RESEARCH_VERSIONS)
        except ImportError:
            pass
        ...
        try:
            from .templates.generation_prompts import (
                ...
                PROMPT_VERSIONS as GENERATION_VERSIONS,
            )
            ...
            cls._template_mappings.update(GENERATION_VERSIONS)
        except ImportError:
            pass
