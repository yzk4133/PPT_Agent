...
specifically the SlideWriterAgent and PPTCheckerAgent.
"""
...
# Additional generation prompts can be added here as needed
...
PROMPT_VERSIONS = {
    "xml_ppt_generation_v1": XML_PPT_AGENT_NEXT_PAGE_PROMPT,
    "checker_v1": CHECKER_AGENT_PROMPT,
    "slide_enhancement_v1": SLIDE_ENHANCEMENT_PROMPT,
}
